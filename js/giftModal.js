...
export function initGiftModal() {
    ...
    const overlay = modal?.querySelector("[data-gift-close]");
    const copyBtn = document.getElementById("gift-account-copy");
    ...
    if (!trigger || !modal || !closeBtn || !copyBtn || !numberText || !bankName || !accountName || !feedback)
        return;
